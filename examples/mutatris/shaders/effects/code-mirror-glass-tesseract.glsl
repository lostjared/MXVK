...
// code-mirror-glass-tesseract: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.38;
const float SPIN = 0.18;
const float WARP = 0.72;
const float EFFECT_MIX = 0.66;
const float HUE_SEED = 0.41;
