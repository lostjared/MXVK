...
// code-mirror-diamond-horizon: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.36;
const float SPIN = 0.16;
const float WARP = 0.64;
const float EFFECT_MIX = 0.62;
const float HUE_SEED = 0.12;
