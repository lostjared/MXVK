...
// code-frac-aurora-vault: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.62;
const float SPIN = 0.18;
const float WARP = 0.56;
const float TEX_MIX = 0.58;
const float HUE_RATE = 0.95;
