...
// code-frac-quartz-ripples: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.58;
const float SPIN = 0.15;
const float WARP = 0.51;
const float TEX_MIX = 0.53;
const float HUE_RATE = 0.88;
