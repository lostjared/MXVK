...
// code-mirror-vortex-gallery: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.18;
const float SPIN = 0.33;
const float WARP = 0.73;
const float EFFECT_MIX = 0.69;
const float HUE_SEED = 0.97;
