...
// code-mirror-laser-pagoda: enhanced remix of the mirror shader family.


const float PI = 3.14159265359;
const float TAU = 6.28318530718;
const int STYLE = 17;
const float SEGMENTS = 15.0;
const float FIELD_SCALE = 1.27;
const float SPIN = 0.32;
const float WARP = 0.86;
const float EFFECT_MIX = 0.79;
const float HUE_SEED = 0.35;
