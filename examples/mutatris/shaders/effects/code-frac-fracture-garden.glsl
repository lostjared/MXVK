...
// code-frac-fracture-garden: generated remix of the frac shader family.


const float PI = 3.14159265359;
const float TAU = 6.28318530718;
const int STYLE = 15;
const float SEGMENTS = 13.0;
const float FOLD_SCALE = 1.64;
const float SPIN = 0.23;
const float WARP = 0.69;
const float TEX_MIX = 0.69;
const float HUE_RATE = 1.18;
