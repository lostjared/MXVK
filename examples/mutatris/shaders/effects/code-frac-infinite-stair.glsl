...
// code-frac-infinite-stair: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.57;
const float SPIN = 0.19;
const float WARP = 0.60;
const float TEX_MIX = 0.50;
const float HUE_RATE = 0.86;
