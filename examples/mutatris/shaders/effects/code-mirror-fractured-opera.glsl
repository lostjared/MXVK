...
// code-mirror-fractured-opera: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.31;
const float SPIN = 0.28;
const float WARP = 0.81;
const float EFFECT_MIX = 0.72;
const float HUE_SEED = 0.62;
