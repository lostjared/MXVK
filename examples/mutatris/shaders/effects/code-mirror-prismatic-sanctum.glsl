...
// code-mirror-prismatic-sanctum: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.15;
const float SPIN = 0.27;
const float WARP = 0.76;
const float EFFECT_MIX = 0.72;
const float HUE_SEED = 0.16;
