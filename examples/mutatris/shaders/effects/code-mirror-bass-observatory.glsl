...
// code-mirror-bass-observatory: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.23;
const float SPIN = 0.31;
const float WARP = 0.78;
const float EFFECT_MIX = 0.74;
const float HUE_SEED = 0.76;
