...
// code-frac-zero-gravity-fold: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.67;
const float SPIN = 0.21;
const float WARP = 0.61;
const float TEX_MIX = 0.59;
const float HUE_RATE = 1.14;
