...
// code-mirror-ocean-origami: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.10;
const float SPIN = 0.13;
const float WARP = 0.52;
const float EFFECT_MIX = 0.61;
const float HUE_SEED = 0.38;
