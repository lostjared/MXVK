...
// code-mirror-electric-mandala: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.25;
const float SPIN = 0.34;
const float WARP = 0.90;
const float EFFECT_MIX = 0.80;
const float HUE_SEED = 0.07;
