...
// code-mirror-crystal-ballroom: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.32;
const float SPIN = 0.17;
const float WARP = 0.71;
const float EFFECT_MIX = 0.70;
const float HUE_SEED = 0.58;
