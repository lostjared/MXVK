...
// code-mirror-infinity-rose: enhanced remix of the mirror shader family.


const float PI = 3.14159265359;
const float TAU = 6.28318530718;
const int STYLE = 3;
const float SEGMENTS = 14.0;
const float FIELD_SCALE = 1.26;
const float SPIN = 0.22;
const float WARP = 0.68;
const float EFFECT_MIX = 0.74;
const float HUE_SEED = 0.45;
