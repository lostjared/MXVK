...
// code-mirror-liquid-chandelier: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.08;
const float SPIN = 0.14;
const float WARP = 0.54;
const float EFFECT_MIX = 0.64;
const float HUE_SEED = 0.32;
