...
// code-frac-velvet-recursion: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.76;
const float SPIN = 0.11;
const float WARP = 0.47;
const float TEX_MIX = 0.49;
const float HUE_RATE = 0.80;
