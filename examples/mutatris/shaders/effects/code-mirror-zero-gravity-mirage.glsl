...
// code-mirror-zero-gravity-mirage: enhanced remix of the mirror shader family.


const float PI = 3.14159265359;
const float TAU = 6.28318530718;
const int STYLE = 24;
const float SEGMENTS = 11.0;
const float FIELD_SCALE = 1.13;
const float SPIN = 0.27;
const float WARP = 0.77;
const float EFFECT_MIX = 0.73;
const float HUE_SEED = 0.69;
