...
// code-mirror-celestial-palace: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.22;
const float SPIN = 0.19;
const float WARP = 0.62;
const float EFFECT_MIX = 0.68;
const float HUE_SEED = 0.08;
