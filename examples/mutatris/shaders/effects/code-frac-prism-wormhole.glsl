...
// code-frac-prism-wormhole: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.48;
const float SPIN = 0.26;
const float WARP = 0.70;
const float TEX_MIX = 0.64;
const float HUE_RATE = 1.12;
