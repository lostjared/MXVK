...
// code-frac-diamond-echo: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.72;
const float SPIN = 0.12;
const float WARP = 0.48;
const float TEX_MIX = 0.52;
const float HUE_RATE = 0.82;
