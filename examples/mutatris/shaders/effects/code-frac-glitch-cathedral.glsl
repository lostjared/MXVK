...
// code-frac-glitch-cathedral: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.81;
const float SPIN = 0.28;
const float WARP = 0.80;
const float TEX_MIX = 0.56;
const float HUE_RATE = 1.30;
