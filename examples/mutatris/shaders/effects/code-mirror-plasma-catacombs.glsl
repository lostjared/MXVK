...
// code-mirror-plasma-catacombs: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.24;
const float SPIN = 0.29;
const float WARP = 0.84;
const float EFFECT_MIX = 0.73;
const float HUE_SEED = 0.51;
