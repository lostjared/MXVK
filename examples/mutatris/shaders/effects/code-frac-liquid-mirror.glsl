...
// code-frac-liquid-mirror: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.38;
const float SPIN = 0.16;
const float WARP = 0.42;
const float TEX_MIX = 0.46;
const float HUE_RATE = 0.72;
