...
// code-frac-mandala-pulse: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.52;
const float SPIN = 0.17;
const float WARP = 0.54;
const float TEX_MIX = 0.72;
const float HUE_RATE = 1.00;
