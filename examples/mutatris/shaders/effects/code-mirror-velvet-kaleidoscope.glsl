...
// code-mirror-velvet-kaleidoscope: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.16;
const float SPIN = 0.18;
const float WARP = 0.58;
const float EFFECT_MIX = 0.67;
const float HUE_SEED = 0.64;
