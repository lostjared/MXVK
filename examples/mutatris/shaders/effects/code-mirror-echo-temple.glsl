...
// code-mirror-echo-temple: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.14;
const float SPIN = 0.20;
const float WARP = 0.66;
const float EFFECT_MIX = 0.65;
const float HUE_SEED = 0.90;
