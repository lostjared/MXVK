...
// code-frac-laser-orchid: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.56;
const float SPIN = 0.26;
const float WARP = 0.76;
const float TEX_MIX = 0.73;
const float HUE_RATE = 1.32;
