...
// code-mirror-spectral-basilica: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.20;
const float SPIN = 0.25;
const float WARP = 0.79;
const float EFFECT_MIX = 0.78;
const float HUE_SEED = 0.25;
