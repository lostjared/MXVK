...
// code-mirror-chromatic-monolith: enhanced remix of the mirror shader family.
...
const float FIELD_SCALE = 1.34;
const float SPIN = 0.26;
const float WARP = 0.88;
const float EFFECT_MIX = 0.75;
const float HUE_SEED = 0.03;
