...
// code-frac-chromatic-rift: generated remix of the frac shader family.
...
const float FOLD_SCALE = 1.60;
const float SPIN = 0.22;
const float WARP = 0.64;
const float TEX_MIX = 0.62;
const float HUE_RATE = 1.16;
