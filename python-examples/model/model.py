...
class ModelWindow(mxvk.VK_Window):
    TITLE_TEXT = "MXVK Model Loader"
...
def main() -> int:
    ...
    window = None
    try:
        window = ModelWindow(filename, args.path, "MXVK Model Test", width, height, args.fullscreen, args.enable_vsync)
        window.loop()
